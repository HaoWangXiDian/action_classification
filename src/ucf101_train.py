...
flags.DEFINE_string("train_file_range", [0, 408], "range of training files")
flags.DEFINE_string("train_file_name_prefix", "../data/peat.genes.TSSAll.+100.-300_50_train_winsize100.seg", "Training Input files prefix")
flags.DEFINE_string("train_file_name_postfix", "", "Training  Input files postfix")
flags.DEFINE_string("test_file_range", [0, 170], "range of test files")
flags.DEFINE_string("test_file_name_prefix", "../data/peat.genes.TSSAll.+100.-300_50_test_winsize100.seg", "Test Input files prefix")
...
# model parameters
flags.DEFINE_integer("input_size", 212, "Input dimensionality [212]")
flags.DEFINE_integer("sequence_size", 100, "Sequence_size")

flags.DEFINE_integer("number_layers", 2, "Number of LSTM units")
flags.DEFINE_integer("number_hidden", 1024, "Number of hidden units")

flags.DEFINE_integer("output_size", 2, "Output dimensionality [2]")
flags.DEFINE_integer("sequence_classifer_type", 2, "Sequence Classifier Type 1: original 2: Applies CNN")
