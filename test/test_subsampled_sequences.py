...
flags.DEFINE_string("train_file_name_prefix", 'ucf_train', "number of training files")
...
flags.DEFINE_string("test_file_name_prefix", 'ucf_test', "number of training files")
